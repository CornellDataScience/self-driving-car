...
class ImageFeature(object):
    def __init__(self, image, params):
        ...
        self.detector = cv2.ORB_create() #params.feature_detector
        self.extractor = self.detector #params.descriptor_extractor
        self.matcher = cv2.BFMatcher(cv2.NORM_HAMMING, crossCheck=True) #params.descriptor_matcher
